...
- fnoseeder will now be installed in either ```$GOROOT/bin``` or
...
* The `fnoseeder` executable will be installed to `$GOPATH/bin`.  `GOPATH`
  defaults to `$HOME/go` (or `%USERPROFILE%\go` on Windows) if unset.

For more information about Fonero and how to set up your software please go to
our docs page at [docs.fonero.org](https://docs.fonero.org/getting-started/beginner-guide/).
...
The [integrated github issue tracker](https://github.com/fonero-project/fnoseeder/issues)
is used for this project.

## License

fnoseeder is licensed under the [copyfree](http://copyfree.org) ISC License.
